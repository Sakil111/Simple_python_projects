...
def formate_data(account):
    '''Take the account data and print it into formateable formate'''
...
while game_should_continue:
    ...
    # Score keeping
    # get follower count each accounts
...
# making account at B become the next position at A